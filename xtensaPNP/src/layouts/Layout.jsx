  ...
  return (
    <div className=''>
			<nav className={navBarStyle}>
				<Link to="/app-home"> <div className={navBarStyleElements}>Home</div> </Link>
				<Link to="/home"> <div className={navBarStyleElements}>Vision</div> </Link>
				...
				<Link to="/app-modules"> <div className={navBarStyleElements}>Modules</div> </Link>
