...
const MANUAL_JOB_SETUP='MANUAL_JOB_SETUP';
const SPINDEL_END_EFFECTOR='SPINDEL_END_EFFECTOR';
const PART_PICKER_END_EFFECTOR='PART_PICKER_END_EFFECTOR';

const ANALOG_READ='ANALOG_READ';
...
export {
    ...
    MANUAL_JOB_SETUP,
    SPINDEL_END_EFFECTOR,
    PART_PICKER_END_EFFECTOR,
