...
import appLinker, { CONTROLPANEL_FEEDRATE, CONTROLPANEL_SELECTED_TOOL, CONTROLPANEL_UNIT, CONTROLPANEL_UNITZ, EXECUATABLE_PROCESS, userStorage } from '../utils/utils';
  ...
  return(<>
    <div className='float-right w-[300px]  '>
      ...
      <div className='grid grid-cols-5 grid-rows-5 gap-1   w-full h-[300px] my-2'>
        ...
        <div className='row-start-1 col-start-1 row-span-1 col-span-1'><div className={buttonStyle} onClick={()=>{}}>01</div></div>
        ...
        <div className='row-start-5 col-start-1 row-span-1 col-span-1'><div className={buttonStyle} onClick={()=>{}}>07</div></div>
