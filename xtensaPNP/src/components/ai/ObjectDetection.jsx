    ...
    tf.ready().then(async () => {
      ...
      ((userModel||{}).models||[]).forEach((element,index) => {
          ...
          modelCheckListArrayBuffer.push(<>
            <div>
            <input id={element.modelName} value="" class="hidden peer" required=""  type="checkbox" onChange={event=>{
            ...
            <label for={element.modelName} class="inline-flex items-center justify-between w-full p-5 
            text-gray-500 
            bg-white border-2 
            border-gray-200 
            rounded-lg 
  ...
  return (
    <>
       <div className={(userModel||{}).className||''} ref={contentDiv}>
        ...
        <div className="w-[300px] sm:w-[350px] float-center grid gap-6"> 
            {modelCheckList}
        </div>
